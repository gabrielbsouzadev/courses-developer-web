...
<?php function verProdutos($modo){?><table width="100%" height="100" border="0">
  <tr>
    ...
    <td width="111" height="50" align="center" valign="middle" bgcolor="#FFCC99">Buscar</td>
    <td colspan="2" width ="200" align="center" valign="middle" bgcolor="#FFCC99"><label for="buscar"></label>
      <input type="text" name="buscar" id="buscar" /></td>
    <td colspan="5" align="center" valign="middle" bgcolor="#FFCC99"><input type="submit" name="Aceitar" id="Aceitar" value="Buscar" /></td>
  </tr>
  <tr>
