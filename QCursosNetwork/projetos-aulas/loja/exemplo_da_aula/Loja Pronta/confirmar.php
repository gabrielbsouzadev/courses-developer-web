...
<form id="form2" name="form2" method="post" action="http://hidesign.makelabor.com/mandar.php">
<table width="458" border="0">
  ...
  <tr>
    <td bgcolor="#FFFFCC">Nome do Produto</td>
    <td bgcolor="#FFFFCC"><input type="text" name="np" id="np" /></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFCC">Quantidade</td>
    <td bgcolor="#FFFFCC"><input type="text" name="qu" id="qu" /></td>
  </tr>
