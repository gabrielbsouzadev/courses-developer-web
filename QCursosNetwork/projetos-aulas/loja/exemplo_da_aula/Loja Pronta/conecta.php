<?php
$conexao = mysqli_connect('loja' , 'root', '') or die ( 'Não foi possivel conectar ao banco de dados');
...
<td><input type="text" value="Buscar" style="width:200px; height:23px; border:none; background:#666; color:#FFF;" name="buscar" id="buscar" /></td> 
<td width="343" align="center" valign="middle"><input type="submit" name="Aceitar" id="Aceitar" value="Buscar" /></td>
</form> 
</td> 
  <tr>
